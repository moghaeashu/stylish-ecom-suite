  ...
  return (
    <footer className="bg-secondary mt-auto">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=accessories" className="text-muted-foreground hover:text-foreground transition-colors">
                  Accessories
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-muted flex flex-col sm:flex-row justify-between items-center gap-4">
